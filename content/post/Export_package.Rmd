...
![](https://amirdjv.github.io/static/post/Export_package/graphPPT.gif){width=300px}

Same can be done to word:
```{r, eval=FALSE}
graph2doc(graph, file = "myGraph.docx")
```
![](https://amirdjv.github.io/static/post/Export_package/graphDOC.gif){width=300px}
...
```
![](https://amirdjv.github.io/static/post/Export_package/fitXLSX.gif){width=300px}
...
![](https://amirdjv.github.io/static/post/Export_package/graphsPPT.gif){width=300px}
