...
![](D:/Amir/Dropbox/MySite/AmirDJV.github.io/public/img/R_and_RStudio_tricks_and_shortcuts/Ctrl_Alt.gif){width=300px}
...
![](D:/Amir/Dropbox/MySite/AmirDJV.github.io/public/img/R_and_RStudio_tricks_and_shortcuts/Ctrl_Alt_right_click_mouse.gif){width=300px}

3. Alt  + right click mouse

![](D:/Amir/Dropbox/MySite/AmirDJV.github.io/public/img/R_and_RStudio_tricks_and_shortcuts/Alt_right_click_mouse.gif){width=300px}

4. Alt  + Shift right click mouse

![](D:/Amir/Dropbox/MySite/AmirDJV.github.io/public/img/R_and_RStudio_tricks_and_shortcuts/Alt_Shift_right_click_mouse.gif){width=300px}
...
![](D:/Amir/Dropbox/MySite/AmirDJV.github.io/public/img/R_and_RStudio_tricks_and_shortcuts/convert_slash_addin.gif){width=800px}

Furthermore, we can create a keyboard shortcut for easier use (I like to use Ctrl+Shift+V)

![](D:/Amir/Dropbox/MySite/AmirDJV.github.io/public/img/R_and_RStudio_tricks_and_shortcuts/convert_slash_keyboard.gif){width=800px}
