...
![](https://amirdjv.github.io/static/post/R_and_RStudio_tricks_and_shortcuts/Export_package_for_exporting_graphs_and_R_output_to_editable_word_powerpoint_and_office/graphPPT.gif){width=300px}

Same can be done to word:
```{r, eval=FALSE}
graph2doc(graph, file = "myGraph.docx")
```
![](https://amirdjv.github.io/static/post/R_and_RStudio_tricks_and_shortcuts/Export_package_for_exporting_graphs_and_R_output_to_editable_word_powerpoint_and_office/graphDOC.gif){width=300px}
...
```
![](https://amirdjv.github.io/static/post/R_and_RStudio_tricks_and_shortcuts/Export_package_for_exporting_graphs_and_R_output_to_editable_word_powerpoint_and_office/fitXLSX.gif){width=300px}
...
![](https://amirdjv.github.io/static/post/R_and_RStudio_tricks_and_shortcuts/Export_package_for_exporting_graphs_and_R_output_to_editable_word_powerpoint_and_office/graphsPPT.gif){width=300px}
